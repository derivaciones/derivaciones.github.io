...
window.addLoadListener(function() {
  var ast, codeElem, container, example, examplesElem, i, index, len, parser, rawContent, results;
  examplesElem = document.querySelector('#examples');
  parser = new derivaciones.Parser;
  results = [];
  for (index = i = 0, len = examples.length; i < len; index = ++i) {
